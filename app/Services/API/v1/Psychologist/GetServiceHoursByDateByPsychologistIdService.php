...
{
    public function execute(int $psychologist_id, string $date): Collection
    {
        return parent::getPsychologistAvailabilityCalendarByDateByPsychologistId($psychologist_id, $date)->get();
    }
}
