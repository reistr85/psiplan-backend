...
class PsychologistSpecialtyRepository
{
    private $model;

    public function __construct(PsychologistSpecialty $model)
    {
        $this->model = $model;
    }
    ...
    public function destroy(PsychologistSpecialty $psychologist_specialty)
    {
        return  $psychologist_specialty->delete();
    }
}
