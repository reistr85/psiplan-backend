@component('mail::message')
    ...
    <p style="text-align: justify">Plataforma escolhida: {{ $data['video_platform'] }}</p>
    @endif
    <p style="text-align: justify">Data: {{ $data['date_query'] }}</p>
    <p style="text-align: justify">Hora: {{ $data['hour_query'] }}</p>
    <p style="text-align: justify">Cliente: {{ $data['client_name'] }}</p>
    <p style="text-align: justify">Fale com o cliente {{ $data['client_contact'] }}</p>
