...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(PsychologistPreferencesTableSeeder::class);
        ...
        $this->call(PagarmeSubscriptionTableSeeder::class);
        $this->call(PagarmeSubscriptionTransactionTableSeeder::class);
    }
}
